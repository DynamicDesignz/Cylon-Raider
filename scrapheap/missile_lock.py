...
def main():
    ...
    if opt_Choice == "0":
        ...
        time.sleep(2)
        print 'The airodump-ng --band abg feed will be updated in 5 second intervals to a *.csv file'
        time.sleep(3)
        os.system('clear')
        cmd_String = "airodump-ng --band abg -i wlan1mon -w %s --write-interval 5 -o csv" % temp_airodump_recon_csv_file
